...
export default function SignIn() {
  ...
  return ( 
  <>
  <div className='hero-container signin-background'>
      <ToastContainer />
      <h3 className='sign-up'>ADMINISTRAR CUADROS ART</h3>
      ...
      <img src="/images/login_painting_2.jpg" alt="door" className="login-image"></img>
